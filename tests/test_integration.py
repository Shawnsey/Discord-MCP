...
class TestDiscordClientIntegration:
    ...
    async def test_discord_client_rate_limiting(self, test_settings):
        ...
        assert (
            client.rate_limiter.requests_per_second
            == test_settings.rate_limit_requests_per_second
        )
    ...
    def test_environment_variable_loading(self):
        ...
        with patch.dict(
            ...
            assert (
                ...
                == "FAKE_BOT_TOKEN_FOR_TESTING_xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
            )
...
class TestEndToEndFunctionality:
    ...
    def test_server_with_all_features_enabled(self):
        ...
        assert server.settings.get_allowed_guilds_list() == [
            "guild1",
            "guild2",
            "guild3",
        ]
        assert server.settings.get_allowed_channels_list() == [
            "channel1",
            "channel2",
            "channel3",
        ]
