...
class TestStringValidator:
    ...
    def test_content_too_long(self):
        ...
        long_content = "x" * 2001
        result = StringValidator.validate_content(
            long_content, "test_field", max_length=2000
        )
...
class TestNumericValidator:
    ...
    def test_value_within_range(self):
        ...
        result = NumericValidator.validate_range(
            7, "test_field", min_value=5, max_value=10
        )
...
class TestValidationMixin:
    ...
    def test_create_validation_error_response(self):
        ...
        validation_result = ValidationResult.error(
            "Test error", ValidationErrorType.INVALID_INPUT
        )
        context = OperationContext("test_operation")

        result = self.mixin._create_validation_error_response(
    ...
    def test_create_permission_denied_response(self):
        ...
        result = self.mixin._create_permission_denied_response(
            "guild", "123456", "Additional info"
        )
    ...
    def test_create_not_found_response(self):
        ...
        result = self.mixin._create_not_found_response(
            "user", "789012", "Additional info"
        )
